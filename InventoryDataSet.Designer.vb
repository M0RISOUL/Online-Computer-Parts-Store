...
Partial Public Class InventoryDataSet
    ...
    Partial Public Class ProductsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddProductsRow(ByVal ProductID As String, ByVal Product_Name As String, ByVal Stock As Integer) As ProductsRow
            Dim rowProductsRow As ProductsRow = CType(Me.NewRow,ProductsRow)
            Dim columnValuesArray() As Object = New Object() {ProductID, Product_Name, Stock}
...
Namespace InventoryDataSetTableAdapters
    ...
    Partial Public Class ProductsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Products` WHERE ((`ProductID` = ?) AND ((? = 1 AND `Product Name` IS"& _ 
                " NULL) OR (`Product Name` = ?)) AND ((? = 1 AND `Stock` IS NULL) OR (`Stock` = ?"& _ 
                ")))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Products` (`ProductID`, `Product Name`, `Stock`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Products` SET `ProductID` = ?, `Product Name` = ?, `Stock` = ? WHERE ((`P"& _ 
                "roductID` = ?) AND ((? = 1 AND `Product Name` IS NULL) OR (`Product Name` = ?)) "& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Online_Computer_Parts_Store.My.MySettings.Default.InventoryConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ProductID, [Product Name], Stock FROM Products"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ProductID As String, ByVal Original_Product_Name As String, ByVal Original_Stock As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal ProductID As String, ByVal Product_Name As String, ByVal Stock As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal ProductID As String, ByVal Product_Name As String, ByVal Stock As Global.System.Nullable(Of Integer), ByVal Original_ProductID As String, ByVal Original_Product_Name As String, ByVal Original_Stock As Global.System.Nullable(Of Integer)) As Integer
            If (ProductID Is Nothing) Then
                Throw New Global.System.ArgumentNullException("ProductID")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Product_Name As String, ByVal Stock As Global.System.Nullable(Of Integer), ByVal Original_ProductID As String, ByVal Original_Product_Name As String, ByVal Original_Stock As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Original_ProductID, Product_Name, Stock, Original_ProductID, Original_Product_Name, Original_Stock)
        End Function
    End Class
